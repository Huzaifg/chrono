...
// =============================================================================
//
// Polaris wheeled vehicle on CRM terrain but with a real slope
//
// =============================================================================
...
int main(int argc, char* argv[]) {
    ...
    switch (patch_type) {
        ...
        case PatchType::HEIGHT_MAP:
            double max_slope_distance = 9;  // This was how the bmp file was made
            double angle = 40;
    ...
    ChVector3d veh_init_pos(-7.5 + 3, 0, 0.15);
