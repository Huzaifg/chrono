...
if __name__ == "__main__":
    ...
    for ns in ns_options:
        file_path = fastPS_folder + f"FSI_Sphere_Bounce{ns}_0" + extension
        data = []
    ...
    file_path = args.base + "/DEMO_OUTPUT/FSI_Sphere_Bounce/" + extension
    ...
    # Plot the data
    plotTimeHistoryMultiple(timeArray, qtyOfInterest, "Sphere Bounce", "Time (s)", "Sphere Height (m)", "SphereBounceAccuracy")
