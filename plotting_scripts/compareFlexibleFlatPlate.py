...
if __name__ == "__main__":
    ...
    extensions = ["CFD_WCSPH", "CRM_WCSPH"]
    ...
    for ext in extensions:
        ...
        for ns in ns_options:
            file_path = fastPS_folder + f"FSI_Flexible_Flat_Plate{ns}_0" + extension
            displacements = []
        ...
        file_path = args.base + "/DEMO_OUTPUT/FSI_Flexible_Flat_Plate/" + extension
        ...
        # Plot the data
        plotTimeHistoryMultiple(timeArray, qtyOfInterest, "Flexible Flat Plate",
                                "Time (s)", "Total Displacement (m)", f"FlexibleFlatPlateAccuracy_{ext}")
